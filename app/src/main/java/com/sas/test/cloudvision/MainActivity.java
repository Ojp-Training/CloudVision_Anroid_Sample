...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button selectImageButton = (Button) findViewById(R.id.btn_choose_image);
        selectedImage = (ImageView) findViewById(R.id.iv_imageView);
        resultTextView = (TextView) findViewById(R.id.tv_label_results);
